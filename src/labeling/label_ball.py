...
OUTPUT_IMAGE_FOLDER = PROJECT_ROOT / "ball_dataset" / "images" / "train"
OUTPUT_LABEL_FOLDER = PROJECT_ROOT / "ball_dataset" / "labels" / "train"
...
for image_path in image_paths:
    ...
    while True:
        ...
        cv2.putText(display, "Drag box around ball | S=save | N=skip | Q=quit",
                    (20, 65), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)

        cv2.imshow("Label Ball", display)
        ...
        if key == ord("s"):
            ...
            saved = save_yolo_label(out_label_path, bbox, w, h)
